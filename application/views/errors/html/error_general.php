...
<head>
    ...
    <title><?php echo !empty($heading) ? strip_tags($heading) : 'System Error'; ?> | BeRewards SPK TOPSIS</title>
        ...
        <div class="clean-error-card p-4 p-md-5 mb-4">
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-4 pb-3 border-bottom">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <span class="badge bg-danger-subtle text-danger border border-danger-subtle px-2 py-1 fs-11 fw-semibold">
                        Application Alert
                    </span>
                </div>
            ...
            <div class="row align-items-center g-4">
                <div class="col-md-7">
                    <div class="icon-circle-avatar mb-3">
                        <i class="ti ti-alert-triangle display-5"></i>
                    </div>
                    <h3 class="fw-bold text-dark mb-2 fs-22"><?php echo !empty($heading) ? $heading : 'Aplikasi Mengalami Kendala'; ?></h3>
                    <p class="text-secondary fs-14 leading-relaxed mb-4">
                        Terjadi kesalahan pada sistem saat memproses instruksi. Hal ini dapat disebabkan oleh parameter yang tidak sesuai atau gangguan pada server aplikasi.
                    </p>

                    <div class="d-flex flex-wrap gap-2">
                        <a href="javascript:location.reload()" class="btn-brand-primary">
                            <i class="ti ti-refresh me-2 fs-18"></i> Muat Ulang Halaman
                        </a>
                        <a href="<?= $base_url; ?>index.php/dashboard" class="btn-brand-secondary">
                            <i class="ti ti-layout-dashboard me-2 fs-18"></i> Beranda Utama
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-5">
                    <div class="info-box-light p-3.5">
                        <h6 class="fw-bold text-danger mb-2 fs-13 text-uppercase tracking-wider">
                            <i class="ti ti-code me-1"></i> Detail Rincian Error
                        </h6>
                        <div class="p-2.5 rounded bg-white mb-3 font-monospace fs-12 border text-danger text-break">
                            <?php echo !empty($message) ? $message : 'An error was encountered.'; ?>
                        </div>
                        
                        <h6 class="fw-semibold text-dark mb-2 fs-12">Rekomendasi Tindakan:</h6>
                        <ul class="ps-3 mb-0 fs-12 text-muted leading-relaxed">
                            <li class="mb-1">Muat ulang halaman browser Anda.</li>
                            <li class="mb-1">Kembali ke modul beranda dashboard.</li>
                            <li>Laporkan kode error di atas ke Tim IT Satker.</li>
                        </ul>
                    </div>
                </div>
            </div>
