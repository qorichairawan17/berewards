...
<div class="modal fade" id="modalTambahTim" tabindex="-1" aria-labelledby="modalTambahTimLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content border-0 shadow-lg">
            ...
            <form id="formTambahTim" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control border-start-0" name="no_sk" placeholder="Contoh: W2.U4/01/SK.TIM-SPK/01/2026" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control border-start-0 datepicker-input" id="add_tanggal_sk" name="tanggal_sk" placeholder="Pilih Tanggal Terbit SK" value="<?= date('Y-m-d'); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" name="perihal" rows="2" placeholder="Contoh: SK Penetapan Tim Penilai SPK Penentuan Reward Pegawai Tahun 2026" required></textarea>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="id_ketua" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="id_sekretaris" required>
                        ...
                        <div class="col-12">
                            <div id="addMemberListContainer" class="d-flex flex-column gap-2">
                                <!-- Dynamic member rows populated by JS script-init -->
                            </div>
                        </div>
