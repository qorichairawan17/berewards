        ...
        <div class="card kpi-card border-0 shadow-sm">
            <div class="card-body p-3 d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h3 class="fw-bold text-dark mb-0 mt-1"><?= count($sk_list); ?> <small class="fs-12 text-muted font-normal">dokumen</small></h3>
        ...
        <div class="card kpi-card border-0 shadow-sm">
            <div class="card-body p-3 d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h3 class="fw-bold text-dark mb-0 mt-1">1 <small class="fs-12 text-muted font-normal">SK Aktif</small></h3>
                    <span class="text-success fs-11 fw-medium"><i class="ti ti-circle-check me-1"></i> Tahun 2026</span>
                </div>
        ...
        <div class="card kpi-card border-0 shadow-sm">
            <div class="card-body p-3 d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h3 class="fw-bold text-dark mb-0 mt-1">5 <small class="fs-12 text-muted font-normal">orang</small></h3>
        ...
        <div class="card kpi-card border-0 shadow-sm">
            <div class="card-body p-3 d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h3 class="fw-bold text-dark mb-0 mt-1">100% <small class="fs-12 text-muted font-normal">terupload</small></h3>
