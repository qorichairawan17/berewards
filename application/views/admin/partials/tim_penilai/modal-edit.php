                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" id="edit_tanggal_sk" required>
                        </div>
                        ...
                        <!-- Section 2: Input Fleksibel Anggota Tim Penilai (Multi-Member Dynamic Input) -->
                            ...
                            <div id="editMemberListContainer" class="d-flex flex-column gap-2">
                                ...
                                <div class="member-row p-3 bg-light rounded-3 border d-flex flex-wrap align-items-center gap-2">
                                    ...
                                    <div class="flex-grow-1" style="min-width: 220px;">
                                        ...
                                        <select class="form-select form-select-sm" name="edit_anggota_peran[]">
