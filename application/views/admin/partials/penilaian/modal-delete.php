...
<div class="modal fade" id="modalHapusPenilaian" tabindex="-1" aria-labelledby="modalHapusPenilaianLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-footer border-top bg-light">
                ...
                <button type="button" class="btn btn-danger" id="btnKonfirmasiHapusPenilaian">Ya, Hapus Data</button>
            </div>
        </div>
    </div>
</div>
