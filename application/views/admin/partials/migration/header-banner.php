<!-- Header Banner Migrasi Database -->
            ...
            <div>
                <div class="d-flex align-items-center gap-2 mb-2">
                    ...
                    <span class="badge bg-primary bg-opacity-20 text-white px-2 py-1 fs-11">
                        CodeIgniter 3 Migration Engine
                    </span>
                </div>
                ...
                <p class="text-white text-opacity-80 fs-13 mb-0">
                    Modul pengelola migrasi struktur tabel database SPK Reward TOPSIS. Eksekusi pembuatan skema (UP) dan pembalikan struktur tabel (DOWN Rollback).
                </p>
            </div>
