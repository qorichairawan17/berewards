            ...
            <form id="formTambahKriteria">
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-12 mt-3" id="add_skala_container">
                            <div class="card border border-warning-subtle bg-warning-subtle bg-opacity-10 rounded-3 p-3 mb-0">
                                <div class="d-flex justify-content-between align-items-center mb-2.5">
                                    ...
                                    <button type="button" class="btn btn-xs btn-outline-primary btn-add-skala-row-add d-flex align-items-center gap-1 fs-11 px-2.5 py-1">
                                        <i class="ti ti-plus fs-13"></i> Tambah Opsi
                                    </button>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-sm table-bordered bg-white align-middle mb-0" id="tableAddSkala">
