        ...
        <div class="row align-items-center position-relative z-1 g-3">
            <div class="col-auto">
                <div class="position-relative">
                    <div class="avatar-xxl rounded-circle bg-white p-2 shadow-sm d-flex align-items-center justify-content-center"
                        ...
                        <img src="<?= base_url($satker['logo']); ?>" alt="Logo Satker" class="img-fluid rounded" style="max-height: 76px;">
                    </div>
            ...
            <div class="col">
                <div class="d-flex flex-wrap align-items-center gap-2 mb-1">
                    <h3 class="fw-bold text-white mb-0 fs-20"><?= html_escape($satker['nama_satker']); ?></h3>
                ...
                <p class="text-white text-opacity-85 mb-1 fs-13">
                    <i class="ti ti-key me-1"></i>Kode Satker: <strong><?= html_escape($satker['kode_satker']); ?></strong> &bull;
                    <i class="ti ti-map-pin me-1"></i>Kode Wilayah: <strong><?= html_escape($satker['kode_wilayah']); ?></strong>
                </p>
                <small class="text-white text-opacity-75 fs-12">
                    <i class="ti ti-building-community me-1"></i>Bawahan: <?= html_escape($satker['pengadilan_tinggi']); ?>
                </small>
            </div>
    ...
    <div class="card-body bg-white py-3 px-4 border-top border-light">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 text-muted fs-12">
            <div class="d-flex align-items-center gap-3">
                <span><i class="ti ti-map-2 text-primary me-1"></i> <?= html_escape($satker['alamat']); ?></span>
                <span class="d-none d-sm-inline">&bull;</span>
                <span><i class="ti ti-phone text-primary me-1"></i> <?= html_escape($satker['telepon']); ?></span>
            </div>
            <div>
                <i class="ti ti-world text-primary me-1"></i> Website: <strong class="text-dark"><?= html_escape($satker['website']); ?></strong>
            </div>
        </div>
    </div>
</div>